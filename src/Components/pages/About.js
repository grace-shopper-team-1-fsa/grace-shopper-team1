...
const About = () => {
    return(
        <div>
            ...
            <p className='about-us-p'>Rooted in the heart of Ireland, we are a passionate team of four, dedicated to capturing the robust beauty and intricate artistry of the medieval era. Our journey began with a shared appreciation for the timeless beauty of medieval craftsmanship. We wanted to bring these stories into today's homes, to share their magic with others who, like us, are captivated by the charm of the past.</p>
            ...
            <p className='about-us-p'>We invite you to explore our curated collection and let the stories behind our vases captivate your imagination, add depth to your décor, and bring the enchantment of the medieval period into your home. From all of us here in Ireland, we look forward to sharing our love of the past with you.</p>
        </div>
    )
}
