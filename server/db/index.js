...
const syncAndSeed = async()=> {
  ...
  const [moe, lucy, larry, ethyl, Essense, Daphne, War, Timeless, Fire] = await Promise.all([
    ...
    Product.create({ 
      ...
      rating: 4,
      productImage: 'https://tinyurl.com/375vwd7j'
    }),
    Product.create({ 
      name: 'Daphne',
      ...
      rating: 5,
      productImage: 'https://tinyurl.com/33ptw762'
    }),
    Product.create({ 
      name: 'War',
      ...
      rating: 5,
      productImage: 'https://tinyurl.com/mawbchfc'
    }),
    Product.create({ 
      name: 'Timeless',
      ...
      rating: 3,
      productImage: 'https://tinyurl.com/bpvt9t4v'
    }),
    Product.create({ 
      name: 'Fire',
